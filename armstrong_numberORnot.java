...
153=1^3+5^3+3^3. 	
(1)The first few are given by 1, 2, 3, 4, 5, 6, 7, 8, 9, 153, 370, 371, 407, 1634, 8208, 9474, 54748, 
*/
import java.util.*;
import java.lang.*;
import java.io.*;
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                // here we sum each number like sum =1+125+27 => 153
                sum = num3 + sum;
            }
            ...
            // number is armstrong
            if (sum == actualnum) {
                System.out.println("Armstrong of >> " +actualnum + " >> " + sum + " >> so its a ARMSTRONG NUMBER .....:)");
            }
            // if sum!=actualnum then its not armstrong number
            else {
                System.out.println("Armstrong of >> " + actualnum + " >> " + sum + " >> so its not a ARMSTRONG NUMBER .....:)");
            }
        }
    }
}
